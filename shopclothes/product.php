...
<script type="text/javascript">
	...
	<div class="super_container_inner">
				...
				<div class="row">
					...
					<div class="col-lg-6 product_col">
						<div class="product_info">
							<div class="product_name"><?php echo $ten_sanpham; ?></div>
							<div class="product_category">In <a href="#"><?php echo $loai_sanpham; ?></a></div>
							<div class="product_price"><?php echo str_replace(",",".",number_format($gia)); ?><span>VNĐ</span></div>
							...
							<div class="product_buttons">
								<div class="text-right d-flex flex-row align-items-start justify-content-start">
									<a ><div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center themhang" >
		...
		<div class="row">
		</div><div class="col-xl-12"><?php echo '<img src="images/'.$link_anhchitiet.'">'; ?></div>
		</div>
		<!-- Footer -->
			</div>
		</div>
