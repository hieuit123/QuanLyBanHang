        ...
        <div class="row">
            <div class="col">
                <div class="boxes_container d-flex flex-row align-items-start justify-content-between flex-wrap">
                    ...
                    <div class="box">
                        ...
                        <div class="box_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="box_right text-center">
                                <div class="box_title">Xu hướng năm 2019</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Box -->
                    <div class="box">
                        <div class="background_image" style="background-image:url(images/home_5.jpg)"></div>
                        <div class="box_content d-flex flex-row align-items-center justify-content-start">
                            <div class="box_left">
                                <div class="box_image">
                                    <a href="category.html">
                                        <div class="background_image" style="background-image:url(images/home_4.jpg)"></div>
                                    </a>
                                </div>
                            </div>
                            <div class="box_right text-center">
                                <div class="box_title">Lựa chọn của nhiều người</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="box_right text-center">
                                <div class="box_title">Bộ sưu tập Hè 2019</div>
                            </div>
                        </div>
                    </div>
