...
<body>
    <script type="text/javascript">
        function kiemtra() {
            ...
            temp = new RegExp("[\\w]{6,}$");
            var kt_mk = temp.test(matkhau);
            if(!kt_mk) {
                alert("Mật khẩu không hợp lệ! Phải từ 6 kí tự!")
                return false;
            }
            if (matkhau == "") {
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post" onsubmit="return kiemtra();" action="xulydangky.php">
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter password">
                        <input class="input100" type="password" id="pass" name="matkhau" placeholder="Mật khẩu có ít nhất 6 kí tự">
                        <span class="focus-input100"></span>
                    </div>
