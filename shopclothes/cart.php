                        ...
                        <div class="cart_extra_content cart_extra_total">
                            ...
                            <ul class="cart_extra_total_list">
                                ...
                                <li class="d-flex flex-row align-items-center justify-content-start" id="ip-diachi">
                                    ...
                                    <div class="cart_extra_total_title">Địa chỉ:
                                        <?php echo $diachi; ?>
                                    </div>

                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div class="cart_extra_total_title">Phương thức thanh toán</div>
                                    <div class="cart_extra_total_value ml-auto"><select><option>Tiền mặt</option><option>Online</option></select></div>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div class="cart_extra_total_title">Tổng tiền</div>
                                    <div class="cart_extra_total_value ml-auto">
                                        <?php echo str_replace(",",".",number_format($tong_tien)); ?> VNĐ</div>
